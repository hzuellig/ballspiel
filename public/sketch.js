...
//nicole
function move_3() {
    //provisorisch, damit es weitergeht
    settings.ballx = width;
}
...
function move_4() {
  ...
  //die Variable settings.ballx updaten!!
  settings.ballx= sox;
...
function move_5() {
  ...
  /*
  Die Variable settings.ballx updaten damit die nächste Animation starten kann!! 
  Was ist der Trigger Punkt?
  Hier einfach mal manuell hart gecodet nach 10 sekunden
  */
